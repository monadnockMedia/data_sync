...
#
bu = home+"/exhibit/projection"+str(time.time())+".db"
db = home+"/exhibit/projection.db"

if isfile(db):
	shutil.copyfile(db,bu)

defFile = home+"/exhibit/chart_definitions.csv"
serFile = home+"/exhibit/iproj_series.csv"
